...
dygraph_1 <- dygraph(excel, main = "PIB Mundial de los Últimos dos Milenios <br><small>Producción total de la economía mundial. Estos datos están ajustados por inflación y diferencias en el costo de vida entre países.</small>") %!>% 
  dySeries("gdp", 
...
dygraph_2 <- dygraph(excel, main = "Población total que vive en pobreza extrema por región del mundo (millones de habitantes)<br><small>La pobreza extrema se define como vivir por debajo del umbral internacional de pobreza de 2,15 dólares al día.</small>") %!>% 
