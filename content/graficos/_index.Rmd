...
<div class="tab-content" id="nav-tabContent">
  ...
  <div class="tab-pane fade show active" id="pibmundial" role="tabpanel" aria-labelledby="pibmundial-tab">
```{r pibmundial, echo=FALSE, warning=FALSE, out.width=500}
pib_mundial
```
</div>

<div class="tab-pane fade show active" id="pobrezamundial" role="tabpanel" aria-labelledby="pobrezamundial-tab">
```{r pobrezamundial, echo=FALSE, warning=FALSE, out.width=500}
pobreza_mundial
``` 
</div>

<div class="tab-pane fade show active" id="esperanzavidamundial" role="tabpanel" aria-labelledby="esperanzavidamundial-tab">
