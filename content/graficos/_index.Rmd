...
dygraph_grafico_1 <- dygraph(excel, main = "PIB Mundial de los Últimos dos Milenios") %!>% 
  dySeries("gdp", 
...
dygraph_grafico_2 <- dygraph(excel, main = "Población total que vive en pobreza extrema por región del mundo (millones de habitantes)") %!>% 
...
dygraph_grafico_3 <- dygraph(data, main = "Esperanza de Vida<br><small>1770-2021</small>") %!>% 
  dySeries("Oceania", 
