...
<ul class="nav nav-tabs" role="tablist">
     <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li class=""><a href="#const" data-toggle="tab" aria-expanded="false" aria-controls="first-tab">
          Construcción </a></li>
...
``` 
  ...
  <div class="tab-pane fade" id="const" role="tabpanel" aria-labelledby="const-tab">
```{r ine-const, echo=FALSE, warning=FALSE, out.width=500}
