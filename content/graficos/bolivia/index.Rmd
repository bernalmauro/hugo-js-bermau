...
<div class="row">
```{r dygraph1,fig.width= 6, fig.height= 4.5, echo=FALSE, out.width="99%"}
...
<div class="row">
<div class="col-lg-6">
```{r dygraph2,fig.width= 6, fig.height= 4.5, echo=FALSE, out.width="99%"}
...
dygraph(pib2, main = "Producto Interno Bruto según Actividad Económica<br><small>(En Millones de Bs)</small>") %!>% 
  ...
  dyLegend(show = "onmouseover", labelsDiv = "labelspib2", labelsSeparateLines = TRUE) %!>% 
  ...
  dyUnzoom()
```
<div id="labelspib2"></div>
</div>
<div class="col-lg-6">
```{r dygraph3,fig.width= 6, fig.height= 4.5, echo=FALSE, out.width="99%"}
...
dygraph(pib3, main = "Producto Interno Bruto según Tipo de Gasto<br><small>(En Millones de Bs)</small>") %!>% 
  ...
  dyLegend(show = "onmouseover", labelsDiv = "labelspib3", labelsSeparateLines = TRUE) %!>% 
  dyOptions(stackedGraph = TRUE, axisLineColor = "#98918B") %!>%
  dyAxis("x", drawGrid = FALSE) %>%
  dyAxis("y",
         valueRange = c(-50000,305000),
