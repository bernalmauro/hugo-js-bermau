...
conjunto_datos_plotly <- conjunto_datos %>%
  pivot_longer(!Fecha, names_to = "variables", values_to = "valores")

titulo <- "Balance Activo del BCB"
titulo_plotly <- "<b>Balance Activo del BCB</b><br>Millones Bs"
...
dygraph_bcb_activo_simple <- 
  ...
  layout(
    ...
    xaxis = list( 
      ...
      showline =TRUE,  
      linecolor = F,
      ticks = 'outside'  # Mostrar los ticks en el eje y
    ), 
    yaxis = list( 
      zerolinewidth = 1, 
      showgrid = F,
    ...
    title = list(text = titulo_plotly, x = 0.9, font = list(color = '#e3e3e3', family = "Constantia", size=15)), 
    legend = list(font = list(color = '#e3e3e3',size = 12, family = "Constantia"), orientation="h"),  
    annotations = list(
      list(
        x = -0,  
        y = 1.07,  
