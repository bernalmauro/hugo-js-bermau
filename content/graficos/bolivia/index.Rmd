...
plotly_grafico_remesas_pais_lineal_bs <-  plotly_bs(conjunto_datos_bs, mi_paleta_plotly, titulo_plotly_bs)
plotly_grafico_remesas_pais_lineal_usd <-  plotly_usd(conjunto_datos_usd, mi_paleta_plotly, titulo_plotly_usd)

plotly_grafico_remesas_pais_lineal_y_stacked_bs <-  plotly_grafico_remesas_pais_lineal_bs %>% layout(
  updatemenus = list(
    list(
      x = 0.20, 
      y = 1.20,
...
plotly_grafico_remesas_pais_lineal_y_stacked_usd <-  plotly_grafico_remesas_pais_lineal_usd %>% layout(
  updatemenus = list(
    list(
      x = 0.20, 
      y = 1.20,
...
plotly_grafico_tipo_real_lineal_bs <-  plotly_bs(conjunto_datos_bs, mi_paleta_plotly, titulo_plotly_bs)
...
plotly_grafico_ponderadores_comercio_lineal_bs <-  plotly_bs(conjunto_datos_bs, mi_paleta_plotly, titulo_plotly_bs)


plotly_grafico_ponderadores_comercio_lineal_y_stacked_bs <-  plotly_grafico_ponderadores_comercio_lineal_bs %>% layout(
  updatemenus = list(
    list(
      x = 0.20, 
      y = 1.20,
...
<ul class="nav nav-tabs" role="tablist">
     <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li class=""><a href="#ireal" data-toggle="tab" aria-expanded="false" aria-controls="tercer-tab">
          Tipo de Cambio Real</a></li>
          <li class=""><a href="#pondcomercio" data-toggle="tab" aria-expanded="false" aria-controls="tercer-tab">
...
``` 
  ...
  <div class="tab-pane fade" id="pondcomercio" role="tabpanel" aria-labelledby="pondcomercio-tab">
```{r bcb-pondcomercio, echo=FALSE, warning=FALSE, out.width=500}
