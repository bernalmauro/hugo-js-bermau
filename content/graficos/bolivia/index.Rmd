...
plotly_activo_lineal_bs <-  function(conjunto_datos, mi_paleta_plotly, titulo_activo_plotly_bs, caption) {
  
  conjunto_datos_pasivo_plotly <- conjunto_datos %>%
    pivot_longer(!Fecha, names_to = "variables", values_to = "valores")
  
  
  plot_ly(data = conjunto_datos_pasivo_plotly, x = ~Fecha, y = ~valores,
    ...
    layout(
      ...
      title = list(text = titulo_activo_plotly_bs, x = 0.9, font = list(color = '#e3e3e3', family = "Constantia", size=15)), 
...
plotly_activo_lineal_usd <-  function(conjunto_datos_usd, mi_paleta_plotly, titulo_activo_plotly_usd, caption) {
  
  conjunto_datos_pasivo_plotly_usd <- conjunto_datos_usd %>%
    pivot_longer(!Fecha, names_to = "variables", values_to = "valores")
  
  plot_ly(data = conjunto_datos_pasivo_plotly_usd, x = ~Fecha, y = ~valores,
          color = ~variables, type = "scatter", mode = "lines", colors = mi_paleta_plotly) %>% 
    config(scrollZoom = FALSE, responsive = TRUE, displaylogo = FALSE,
           toImageButtonOptions = list(format= 'png', # one of png, svg, jpeg, webp
                                       filename= 'custom_image',
    ...
    layout(
      ...
      title = list(text = titulo_activo_plotly_usd, x = 0.9, font = list(color = '#e3e3e3', family = "Constantia", size=15)), 
      legend = list(font = list(color = '#e3e3e3',size = 12, family = "Constantia"), orientation="h", traceorder= "normal"),  
      annotations = list(
        list(
          x = -0,  
...
plotly_pasivo_lineal_bs <-  function(conjunto_datos, mi_paleta_plotly, titulo_pasivo_plotly_bs, caption) {
  ...
  plot_ly(data = conjunto_datos_pasivo_plotly, x = ~Fecha, y = ~valores,
    ...
    layout(
      ...
      title = list(text = titulo_pasivo_plotly_bs, x = 0.9, font = list(color = '#e3e3e3', family = "Constantia", size=15)), 
      legend = list(font = list(color = '#e3e3e3',size = 12, family = "Constantia"), orientation="h", traceorder= "normal"),  
      annotations = list(
        list(
          x = -0,  
...
plotly_pasivo_lineal_usd <-  function(conjunto_datos_usd, mi_paleta_plotly, titulo_pasivo_plotly_usd, caption) {
  ...
  plot_ly(data = conjunto_datos_pasivo_plotly_usd, x = ~Fecha, y = ~valores,
    ...
    layout(
      ...
      title = list(text = titulo_pasivo_plotly_usd, x = 0.9, font = list(color = '#e3e3e3', family = "Constantia", size=15)), 
      legend = list(font = list(color = '#e3e3e3',size = 12, family = "Constantia"), orientation="h", traceorder= "normal"),  
      annotations = list(
        list(
          x = -0,  
...
titulo_activo_plotly_bs <- "<b>Balance Activo del BCB</b><br>Millones Bs"
titulo_activo_plotly_usd <- "<b>Balance Activo del BCB</b><br>Millones $us"
caption <- "bernalmauricio.com"
...
plotly_grafico_activo_lineal_bs <- plotly_activo_lineal_bs(conjunto_datos, mi_paleta_plotly, titulo_activo_plotly_bs, caption)
plotly_grafico_activo_lineal_usd <- plotly_activo_lineal_usd(conjunto_datos_usd, mi_paleta_plotly, titulo_activo_plotly_usd, caption)
...
titulo_pasivo_plotly_bs <- "<b>Balance Pasivo del BCB</b><br>Millones Bs"
titulo_pasivo_plotly_usd <- "<b>Balance Pasivo del BCB</b><br>Millones $us"
caption <- "bernalmauricio.com"
...
plotly_grafico_pasivo_lineal_bs <- plotly_pasivo_lineal_bs(conjunto_datos, mi_paleta_plotly, titulo_pasivo_plotly_bs, caption)
plotly_grafico_pasivo_lineal_usd <- plotly_pasivo_lineal_usd(conjunto_datos_usd, mi_paleta_plotly, titulo_pasivo_plotly_usd, caption)
