...
```
{{< /tab >}}
{{< tab tabName="Ingresos y Gastos Financieros (anualizado)">}}
```{r knitr-gastos, out.width='100%', echo=FALSE}
knitr::include_graphics("/images/asfi/ingresos/Cargos por Oblig. con el B.C.B._Oblig. con el B.C.B..png", error = FALSE)
knitr::include_graphics("/images/asfi/ingresos/Int. Depósitos Caja de Ahorro_Oblig. Púb. Ctas. Ahorro", error = FALSE)
knitr::include_graphics("/images/asfi/ingresos/Int. Depósitos Púb. a Plazo_Depósitos Púb. a Plazo.png", error = FALSE)
knitr::include_graphics("/images/asfi/ingresos/Int. Oblig. con Emp. públicas_Oblig. cemp. públicas", error = FALSE)
...
```
{{< tab tabName="Rentabilidad (anualizado)">}}
```{r knitr-gastos, out.width='100%', echo=FALSE}
...
```
{{< tab tabName="Cálculo del Spread Efectivo (anualizado)">}}
```{r knitr-gastos, out.width='100%', echo=FALSE}
...
```
{{< tab tabName="Utilización del Spread Efectivo (anualizado)">}}
```{r knitr-gastos, out.width='100%', echo=FALSE}
