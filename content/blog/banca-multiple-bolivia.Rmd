...
knitr::include_graphics("/images/asf2i/activos/Disponibilidades_Activos.png", error = FALSE)
```
{{< /tab >}}
...
```{r knitr-balance_bmu, out.width='50%', echo=FALSE}
...
```{r knitr-activos_bmu, out.width='50%', echo=FALSE}
knitr::include_graphics("/images/asfi/activos_bmu.png", error = FALSE)
```


```{r knitr-seprec, out.width='50%', echo=FALSE}
