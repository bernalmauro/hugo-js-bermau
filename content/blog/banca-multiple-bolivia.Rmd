...
knitr::include_graphics("/images/asfi2/obligaciones/Días de permanencia de los depósitos a plazo fijo.png", error = FALSE)
...
```{r knitr-balance_bmu, out.width='100%', echo=FALSE}
...
```{r knitr-activos-bmu, out.width='100%', echo=FALSE}
...
```{r knitr-pasivos-bmu, out.width='100%', echo=FALSE}
