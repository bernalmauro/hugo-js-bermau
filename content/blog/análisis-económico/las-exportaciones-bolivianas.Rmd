...
grafico_barra_exportaciones_producto <- plot_ly(
  ...
  layout(
    title = "Top 10 Productos de Exportación <br> Enero a Octubre 2023(p) <br> (En Millones USD)",
...
grafico_torta_destino_pais <- plot_ly() %>%
  ...
  layout(
    title = "Principales Destinos de las Exportaciones <br> Enero a Octubre 2023(p) <br> (Millones de USD)",
    showlegend = FALSE,
    titlefont = list(size = 14),
    margin = list(t = 100)
...
grafico_torta_departamentos <- plot_ly() %>%
  ...
  layout(
    title = "Exportaciones por Departamento <br> Enero a Octubre 2023(p) <br> (Millones de USD)",
    showlegend = FALSE,
    titlefont = list(size = 14),
