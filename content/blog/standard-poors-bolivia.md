...
Algo que el informe rescata son los pagos "relativamente bajos del servicio de deuda externa" del país (GRAFICOS). Para entender la composición del servicio de la deuda pensemos en uno mismo que acude al banco, le aprueban un préstamo donde mes a mes paga cierto monto compuesto principalmente por pagos de capital e intereses. 
