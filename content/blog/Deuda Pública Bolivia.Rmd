...
total_porcentaje_pib <-
 dygraph(total_porcentaje, main = "Deuda Pública Bolivia (en % del PIB)")%!>%  
...
deuda_latinoamerica <-
  dygraph(data, main = "Economías mas y menos endeudadas de Latinoamérica (% del PIB)") %!>% 
...
creci_deuda_pib <-
  dygraph(data, main = "Crecimiento Deuda Pública, Crecimiento PIB real") %!>% 
...
interna%>%
  ...
  footnote(general = "Ministerio de Economía y Finanzas Públicas.",
           general_title = "Fuente: ")
